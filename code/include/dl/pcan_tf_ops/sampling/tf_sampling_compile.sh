...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I /ssd/hliubs/dl/venv/lib/python3.6/site-packages/tensorflow/include -I /usr/local/cuda-8.0/include -I /ssd/hliubs/dl/venv/lib/python3.6/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-8.0/lib64/ -L/ssd/hliubs/dl/venv/lib/python3.6/site-packages/tensorflow -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0

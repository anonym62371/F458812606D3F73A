...
import pcan_tf_util as tf_util
from pcan_transform_nets import input_transform_net, feature_transform_net
from pcan_pointnet_util import pointnet_sa_module, pointnet_fp_module, pointnet_sa_module_msg
...
def vlad_forward(xyz, reshaped_input, feature_size=1024, max_samples=4096, cluster_size=64,
    ...
    l1_xyz, l1_points = pointnet_sa_module_msg(xyz, input, 256, [0.1, 0.2, 0.4], [16, 32, 64],
                                               ...
                                               bn_decay, scope='layer1', use_nchw=False)
